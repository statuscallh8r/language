    ...
    const scope = globalThis;
    {
        const parent_scope = scope
        {
            const scope = indentifire.scope(parent_scope)
            {
                ...
                {
                    const scope = indentifire.scope(parent_scope)
                    const _0x0__await_indentifire_0x2e_log_0x28_ = await indentifire.log("Hello, World!")
                    _0x0__await_indentifire_0x2e_log_0x28_
                    const _0x1__await_indentifire_0x2e_log_0x28_ = await indentifire.log("Welcome to Indentifire!")
                    _0x1__await_indentifire_0x2e_log_0x28_
                    const _0x2__await_indentifire_0x2e_log_0x28_ = await indentifire.log("This language uses semantic indentation like Python!")
                    _0x2__await_indentifire_0x2e_log_0x28_
                }
            } 
        }
    } 
