...
void (async () => {
    ...
    const scope = globalThis;
    {
        const parent_scope = scope
        {
            ...
            let b = 5
            b
            const _0x7__a = await a
            let _0x0__a = _0x7__a
            const _0x8__await_indentifire_0x2e_concat_0x28_ = await indentifire.concat("First number: ", _0x0__a)
            const _0x9__await_indentifire_0x2e_log_0x28_ = await indentifire.log(_0x8__await_indentifire_0x2e_concat_0x28_)
            _0x9__await_indentifire_0x2e_log_0x28_
            const _0xa__b = await b
            let _0x1__b = _0xa__b
            const _0xb__await_indentifire_0x2e_concat_0x28_ = await indentifire.concat("Second number: ", _0x1__b)
            const _0xc__await_indentifire_0x2e_log_0x28_ = await indentifire.log(_0xb__await_indentifire_0x2e_concat_0x28_)
            _0xc__await_indentifire_0x2e_log_0x28_
            const _0xd__a = await a
            let _0x2__a = _0xd__a
            const _0xe__b = await b
            let _0x3__b = _0xe__b
            const _0xf__await_indentifire_0x2e_add_0x28_ = await indentifire.add(_0x2__a, _0x3__b)
            let sum = _0xf__await_indentifire_0x2e_add_0x28_
            sum
            const _0x10__a = await a
            let _0x4__a = _0x10__a
            const _0x11__b = await b
            let _0x5__b = _0x11__b
            const _0x12__sum = await sum
            let _0x6__sum = _0x12__sum
            const _0x13__await_indentifire_0x2e_concat_0x28_ = await indentifire.concat("Sum: ", _0x4__a, " + ", _0x5__b, " = ", _0x6__sum)
            const _0x14__await_indentifire_0x2e_log_0x28_ = await indentifire.log(_0x13__await_indentifire_0x2e_concat_0x28_)
            _0x14__await_indentifire_0x2e_log_0x28_
        }
    } 
})();